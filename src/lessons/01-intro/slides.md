...
<!-- class: cards -->
## Воркшоп: разбираем один сайт

- **Адрес** части URL прямо в адресной строке
- **Network** запросы, статусы и JSON
- **Elements** правим страницу у себя
- **Схема** рисуем архитектуру в Excalidraw
